...
#define CDS_SINGLY_LINKED_LIST_H
    ...
    cds_copy_and_create_reverse_singly_linked_list_with_timeout(
        ...
        return cds_copy_and_create_reverse_linked_list_with_timeout(
            sizeof(struct cds_singly_linked_list), src_list, 
            CDS_SINGLY_LINKED_LIST, mutex_timeout, return_state
        );
    }
    ...
    static inline enum cds_status cds_swap_next_singly_linked_list_nodes(
        ...
        return cds_swap_next_singly_linked_list_nodes_with_timeout(
            prev_node_0, prev_node_1, &cds_default_mutex_timeout, return_state
        );
    }
    ...
    cds_swap_free_and_next_singly_linked_list_nodes(
        ...
        return cds_swap_free_and_next_singly_linked_list_nodes_with_timeout(
            prev_node, free_node, &cds_default_mutex_timeout, return_state
        );
    }
    ...
    static inline enum cds_status cds_swap_singly_linked_list(
        struct cds_singly_linked_list* const list_0,
        struct cds_singly_linked_list* const list_1,
        enum cds_status *restrict const return_state
    ){
        return cds_swap_singly_linked_list_with_timeout(
    ...
    static inline struct cds_singly_linked_list*
    cds_pop_singly_linked_list_range(
        struct cds_singly_linked_list_node* const begin_prev,
        struct cds_singly_linked_list_node* const end_prev,
        enum cds_status *restrict const return_state
    ){
        return cds_pop_singly_linked_list_range_with_timeout(
            begin_prev, end_prev, &cds_default_mutex_timeout, return_state
        );
    }

    static inline struct cds_singly_linked_list*
    cds_pop_singly_linked_list_beginning(
        struct cds_singly_linked_list_node *restrict const end_prev,
        enum cds_status *restrict const return_state
    ){
        return cds_pop_singly_linked_list_beginning_with_timeout(
            end_prev, &cds_default_mutex_timeout, return_state
        );
    }
