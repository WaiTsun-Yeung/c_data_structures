...
int main() {
    for (size_t i = 0; i < 1000000; ++i) {
        ...
        struct cds_singly_linked_list_node* list_0_front 
            = cds_singly_linked_list_begin(list_0);
        struct cds_singly_linked_list_node* list_1_front 
            = cds_singly_linked_list_begin(list_1);
        cds_splice_singly_linked_list_range(
            list_0_front, list_1_front, list_1_front->next, &return_state
        );
        if (return_state) return return_state;
        ...
        const struct cds_singly_linked_list_node* node_1 
            = cds_singly_linked_list_begin(list_1);
