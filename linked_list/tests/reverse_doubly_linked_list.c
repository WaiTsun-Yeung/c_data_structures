...
int main() {
    for (size_t i = 0; i < 1000000; ++i){
        ...
        struct cds_doubly_linked_list* list_reverse
            = cds_copy_and_create_reverse_doubly_linked_list(list);
        ...
        for (
            ...
            list_pop_push, cds_doubly_linked_list_pop_front(list)
        );
        for (
            ...
            return 1;
        cds_destroy_doubly_linked_list(&list_pop_push);
        cds_destroy_doubly_linked_list(&list_reverse);
